# Makefile tested on Windows with TDM-GCC compiler toolchain

CC = g++ -std=c++20
LIBS = -lws2_32 -lwsock32

Target = DummyRobotMotorControl.exe
...
DummyRobotMotorControlModuleObj = ${ObjDir}/DummyRobotMotorControlModule.o
...
AllObjs = ${MainObj} ${DummyRobotMotorControlModuleObj} ${Base64Obj} ${LoggerObj} ${R2CPCommandObj} ${R2CPCommandDictionaryObj} ${R2CPPacketProcessorObj} ${R2CPParameterObj} ${R2CPParserObj} ${R2CPRuntimeBrokerObj} ${R2CPSerializerObj} ${R2CPTransceiverQueueObj} ${R2CPWebSocketServerObj}
...
# Compile DummyRobotMotorControlModule.cpp
${DummyRobotMotorControlModuleObj}: DummyRobotMotorControlModule.cpp DummyRobotMotorControlModule.hpp
	${CC} -c -Wall ${DEPS} $< -o $@
...
clean:
	remove-item ${Target}
	remove-item -force -recurse ${ObjDir}
